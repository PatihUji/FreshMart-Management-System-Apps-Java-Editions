...
public class DashboardQualityControl implements Initializable {
    ...
    private void loadBarChartStokKeluarByMonth() {
        ...
        series.setName("Stok Keluar per Bulan");
        ...
        try {
            ...
            String query = "SELECT FORMAT(sk_tanggal_keluar, 'MMMM yyyy', 'id-ID') AS bulan_tahun, " +
            ...
            viewstok.setTitle("Stok Keluar Bulanan");
